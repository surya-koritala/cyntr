...
- **[Cloud ops agent](demos/cloud-ops/)** — investigates AWS/k8s issues read-only, posts findings in Slack.
- **Incident response crew** (coming soon) — pipeline of detector + investigator + reporter agents.
- **Internal helpdesk** (coming soon) — agent over your runbooks with policy-gated cloud-CLI access.
